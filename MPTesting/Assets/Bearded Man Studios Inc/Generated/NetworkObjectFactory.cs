			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					case ChatManagerNetworkObject.IDENTITY:
						...
						break;
					case ChildPlanetNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ChildPlanetNetworkObject(networker, id, frame);
						break;
					case CubeForgeGameNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new CubeForgeGameNetworkObject(networker, id, frame);
						break;
					case EnemyControlNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new EnemyControlNetworkObject(networker, id, frame);
						break;
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ExampleProximityPlayerNetworkObject(networker, id, frame);
						break;
					case LaserNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new LaserNetworkObject(networker, id, frame);
						break;
					case NetworkCameraNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetworkCameraNetworkObject(networker, id, frame);
						break;
					case ParentPlanetNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ParentPlanetNetworkObject(networker, id, frame);
						break;
					case ShipControlNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ShipControlNetworkObject(networker, id, frame);
						break;
					case TestNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new TestNetworkObject(networker, id, frame);
						break;
					case TurretControlNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new TurretControlNetworkObject(networker, id, frame);
						break;
				}
